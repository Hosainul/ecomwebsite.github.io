                                ...
                                <tr>
                                    <td> <img style="width:100%;height:65px" src="{{asset('uploads/product_images')}}/{{$CartGetContent->attributes->product_image}}"  alt=""></td>
                                        ...
                                        <td  class="position-relative">
                                            <a href="{{route('cart_item_remove',$CartGetContent->id)}}" class="d-inline position-absolute" style="top:-23px;right:13px;"><i class="fas fa-trash-alt text-danger"></i></a>
                                        <form action="{{route('cart_item_update',$CartGetContent->id)}}" method="post" class="mt-4">
                                            @csrf
