...
<main>
    <table width:"100%" style="width: 100%">
        ...
        <tbody>
            ...
            @endforeach
            <tr>
                <td colspan="5" style="padding-right: 20px">SUBTOTAL</td>
                <td class="total" style="padding-right: 80px">$ {{$order->total_price}}</td>
            </tr>
            <tr>
                <td colspan="5" style="padding-right: 20px">TAX 0%</td>
                <td class="total" style="padding-right: 80px">$ {{$order->total_price}}</td>
            </tr>
            <tr>
                <td colspan="5" style="padding-right: 20px">GRAND TOTAL</td>
                <td class="grand total" style="padding-right: 80px">$ {{$order->total_price}}</td>
            </tr>
