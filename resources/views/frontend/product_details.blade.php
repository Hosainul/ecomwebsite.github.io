                    ...
                    <div class="img-tab-area">
                        <div class="tab-content tab-img">
                            <div class="tab-pane fade show active" id="img1" role="tabpane">
                                <img class="img-fluid" src="{{asset('uploads/product_images')}}/{{$product_details->product_image}}" alt="">
                            </div>
        ...
        <div class="container">
            ...
            <div class="tab-content pt-4">
                <div class="tab-pane fade show active" id="description" role="tabpanel">
                    <p>{!!$product_details->product_detail_description!!}</p>
                </div>
                ...
                <div class="product-active owl-carousel nav-style">
                    ...
                    <div class="product-wrapper">
                        <div class="product-img">
                            ...
                            <!-- <a href="#"> <img class="secondary-img" src="{{asset('frontend')}}/img/product-img/product1.jpg" alt=""></a> -->
                            <span>hot</span>
