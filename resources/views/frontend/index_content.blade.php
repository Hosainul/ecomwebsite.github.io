            ...
            <div class="slider-active">
                <div class="slider-single-item">
                    ...
                    <div class="slider-text">
                        <h2 class="text-white">Online <span>SHOP</span></h2>
                        <p class="text-white">“Happiness is not in money, but in shopping.”</p>
                        <a style="color: yellow" href="#">View now</a>
                    </div>
                </div>
                <div class="slider-single-item">
                ...
                <div class="slider-single-item">
                    <img src="{{asset('frontend')}}/img/slider-img3.png" class="img-fluid" alt="">
                    <div class="slider-text">
                        <h2 class="text-white">Online <span>SHOP</span></h2>
                        <p class="text-white">“Happiness is not in money, but in shopping.”</p>
                        <a style="color: yellow" href="#">View now</a>
				...
				<div class="col-md-3">
                                    ...
                                    <div class="product-wrapper">
                                        <div class="product-img">
                                            <a href="{{route('product_details',['id'=>$latest_product->id])}}"> <img src="{{asset('uploads/product_images')}}/{{$latest_product->product_image}}" alt=""></a>
                                        ...
                                        <div class="product-content text-center">
                                            ...
                                            <div class="cart-btn">
                                                <a href="{{route('product_details',['id'=>$latest_product->id])}}">Add to cart</a>
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane fade show active" id="allProduct" role="tabpanel">
                                ...
                                <div class="product-active owl-carousel nav-style">
                                    ...
                                    <div class="product-wrapper">
                                        <div class="product-img">
                                            <a href="{{route('product_details',['id'=>$all_product->id])}}"> <img src="{{asset('uploads/product_images')}}/{{$all_product->product_image}}" alt=""></a>
                                            <!-- <a href="#"> <img class="secondary-img" src="{{asset('frontend')}}/img/product-img/product1.jpg"
                                                    alt=""></a> -->
                                            <span>hot</span>
                                            <div class="product-action">
                            ...
                            <div class="tab-pane fade" id="tab{{$all_category->id}}" role="tabpanel">
                                ...
                                <div class="product-active owl-carousel nav-style">
                                    ...
                                    <div class="product-wrapper">
                                        <div class="product-img">
                                            <a href="#"> <img src="{{asset('uploads/product_images')}}/{{$all_product->product_image}}" alt=""></a>
                                            <!-- <a href="#"> <img class="secondary-img" src="{{asset('frontend')}}/img/product-img/product1.jpg"
                                                    alt=""></a> -->
                                            <span>hot</span>
                                            <div class="product-action">
